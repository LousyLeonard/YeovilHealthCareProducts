...
public class IDGenerator {
	...
	public Integer getNewUniqueID(Table table) {
		Integer result = null;
		...
		try
		{
			...
			final Connection conn = DriverManager.getConnection(DatabaseConstants.DATABASE_CONNECTION_CONSTANT, 
					DatabaseConstants.DATABASE_USERNAME, DatabaseConstants.DATABASE_PASSWORD);
			final String query = generateSQLQuery(table);
	...
	public String generateSQLQuery(Table table) {
		String searchQuery = "";
		switch (table) {
		case PRODUCT:
	...
	public static void main(String argv[]) {
		...
		Integer i = generator.getNewUniqueID(Table.PRODUCT);
